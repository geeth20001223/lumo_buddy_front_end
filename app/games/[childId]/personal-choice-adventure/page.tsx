...
export default function PersonalChoiceAdventurePage() {
  ...
  return (
    <main className="relative flex h-screen overflow-hidden flex-col bg-[#fff8fb]">
      <ChoiceAtmosphere />
      ...
      <div className="relative z-10 flex flex-1 min-h-0 flex-col px-3 sm:px-6 py-2">
        ...
        {gameState === "playing" && scenarios.length > 0 && (
          <div className="mx-auto flex w-full max-w-[1180px] flex-1 flex-col justify-between overflow-y-auto rounded-[2.2rem] border border-white/80 bg-white/75 p-4 shadow-[0_26px_74px_rgba(244,114,182,0.12)] backdrop-blur-xl sm:p-6 gap-4">
